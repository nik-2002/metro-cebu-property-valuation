---
name: "writing-plans"
description: "Creates a detailed implementation plan and bite-sized task checklist before any writing or coding begins. Run after brainstorming."
---
...
- **Verification Plan**: How to verify the work is done.
...
## 3. Review
Ask the user to review the Plan and Task list before proceeding.

## Transition
- **Terminal State:** User approved `implementation_plan.md` and `task.md`.
- **Next Step:** Begin executing the plan task by task.
