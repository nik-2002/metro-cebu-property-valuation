...
description: "Use when checking whether a thesis section is technically defensible. Best for methodology, feature engineering, modeling choices, evaluation logic, geospatial features, hedonic regression, Random Forest, XGBoost, and validation claims. Keywords: technical review, methodology review, technical integrity, defensibility, geospatial methods, model rationale."
tools: [read, search]
user-invocable: true
---
