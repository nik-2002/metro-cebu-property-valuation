...
\end{tabular}
\end{center}
\textit{Note.} The three strata are drawn from the 3{,}616-row open-market ABT. The 244-row difference comes from the model-requirement filters (null target or null spatial-lag value, plus the vacant-lot scope filter); Chapter 5 reports the per-stratum breakdown.
\end{table}
