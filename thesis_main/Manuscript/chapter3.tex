...
\draw[arr] (abt) -- (strat);
\end{tikzpicture}
\caption[Data pipeline from multi-portal open-market ingestion\dots]{Data pipeline from multi-portal open-market ingestion to the modeling-ready Analytics Base Table and the three modeling strata.}
