...
\begin{table}[htbp]
\caption{Dar es Salaam Benchmark Results Reported by Nyanda et al. (2024)}
...
A macro control such as the \textbf{BSP RPPI quarterly index} is therefore relevant in principle, following Udomsap and Abid (2020), who confirmed that interest rates and macroeconomic conditions are significant determinants of housing prices.
