...
This study focuses on the residential real estate market within Metro Cebu. While the National Economic and Development Authority (NEDA) defines Metro Cebu as encompassing 13 LGUs, this study operationally scopes ``Metro Cebu'' to its central urban core: \textbf{Cebu City, Mandaue, Lapu-Lapu, Talisay, Minglanilla, and Consolacion}. This constraint supports high data density and robust geospatial analysis, as these six LGUs represent the most active transaction zones and the highest concentration of infrastructure development. Map~\ref{fig:study-area} shows the spatial extent of this scope.

\begin{ccmap}[H]
\centering
\includegraphics[width=0.92\textwidth]{diagrams/lgu_boundaries.png}
\caption{Metro Cebu study area: the six local government units considered.}
