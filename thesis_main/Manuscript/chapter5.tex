...
Figure~\ref{fig:listings-distribution} shows how the 3{,}372 modeled listings fall across the six LGUs, colored by stratum. Coverage concentrates along the urbanized coastal corridor from Talisay through Cebu City and Mandaue to Lapu-Lapu, with condominiums clustering in the dense central and Mactan areas and vacant lots more common toward the southern and outlying barangays.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{diagrams/listings_distribution_map.png}
\caption[Spatial distribution of the modeled open-market listings\dots]{Spatial distribution of the 3{,}372 modeled open-market listings across the six Metro Cebu LGUs, colored by stratum (condominium, houses, vacant lot).}
\label{fig:listings-distribution}
\end{figure}
