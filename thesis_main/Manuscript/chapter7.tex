...
\caption{Mean absolute SHAP value by feature, deployed condominium Random Forest (top 12 features).}
...
\caption{Mean absolute SHAP value by feature, deployed house Random Forest (top 12 features).}
...
\caption{Mean absolute SHAP value by feature, deployed vacant-lot Random Forest (top 12 features).}
\label{fig:shap-lot}
\end{figure}
