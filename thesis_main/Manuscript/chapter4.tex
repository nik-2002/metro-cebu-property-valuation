...
The ABT covered six LGUs: Cebu City, Mandaue City, Lapu-Lapu City, Talisay City, Minglanilla, and Consolacion. Naga City stayed as a CBD distance anchor but was not a training LGU. Cebu City and Lapu-Lapu City together held the largest share of rows, reflecting the concentration of online residential listings in the core and island submarkets. Map~\ref{map:lgu} shows the boundaries of the six study LGUs.

\begin{ccmap}[htbp]
\centering
\includegraphics[width=0.88\textwidth]{diagrams/lgu_boundaries.png}
\caption{The six study LGUs of Metro Cebu.}
\label{map:lgu}
\end{ccmap}
