...
## Decision 59 — MCRAI scoring sensitivity analysis (robustness check; no pipeline change) (2026-06-28)

> Originally authored on `dev/modeling` as Decision 56 (and 57); renumbered to 59 and 60 on merge into `main` to avoid collision with the manuscript-branch Decisions 56–58.
