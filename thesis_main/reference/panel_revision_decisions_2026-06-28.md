...
- **✅ Author confirmed (2026-06-30):** (a) No separate ethics-clearance/IRB form was required — current "did not fall under human-subjects research review" wording retained unchanged. (b) Added an honest, bounded terms-of-use sentence to the data-collection paragraph: acknowledges automated collection of publicly viewable pages, states the study does **not** claim full conformance with portal ToS (some restrict automated access), and notes the data were used only for academic analysis, neither redistributed nor used commercially. No blanket ToS-compliance claim made (consistent with §3.2 CAPTCHA bypass). **D-13 resolved.**
