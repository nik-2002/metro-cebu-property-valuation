...
CANDIDATE_HUBS = [
    ...
    {
        "hub_id":   "it_park",
        "label":    "Cebu IT Park (BPO/tech hub, Lahug)",
        "seed_lat": 10.3304,
        "seed_lon": 123.9053,
        "query":    "Cebu IT Park",
        "peripheral": False,
    ...
    {
        "hub_id":   "minglanilla_poblacion",
        "label":    "Minglanilla poblacion (Town Plaza / Gaisano Grand)",
        "seed_lat": 10.2459,
        "seed_lon": 123.7961,
        "query":    "Minglanilla Town Plaza Gaisano Grand Mall Minglanilla",
        "peripheral": True,
        "radius":   800,
    },
    {
        "hub_id":   "minglanilla_lipata",
        "label":    "Minglanilla Lipata (San Roque Parish / barangay center)",
        "seed_lat": 10.2550,
        "seed_lon": 123.8103,
        "query":    "San Roque de Montpellier Parish Lipata Minglanilla",
        "peripheral": True,
        "radius":   800,
    },
]
